...
describe Eol::Page do
  ...
  let(:pages_raw) do
    [
      { "identifier"=>326447, "scientificName"=>"Gorilla gorilla", "richness_score"=>84.5995, "synonyms"=>[], "vernacularNames"=>[{"vernacularName"=>"Western gorilla", "language"=>"en", "eol_preferred"=>true}, {"vernacularName"=>"gorilla", "language"=>"en"}, {"vernacularName"=>"lowland gorilla", "language"=>"en"}, {"vernacularName"=>"Gorilla gorilla", "language"=>"es", "eol_preferred"=>true}, {"vernacularName"=>"Gorila", "language"=>"es"}, {"vernacularName"=>"Gorille", "language"=>"fr", "eol_preferred"=>true}, {"vernacularName"=>"Горилла", "language"=>"ru", "eol_preferred"=>true}], "references"=>[],
      ...
      { "identifier"=>42003, "scientificName"=>"gorilla", "richness_score"=>60.8969, "synonyms"=>[], "vernacularNames"=>[{"vernacularName"=>"Gorillas", "language"=>"en", "eol_preferred"=>true}], "references"=>[],
        "taxonConcepts"=>[{"identifier"=>24935600, "scientificName"=>"gorilla", "nameAccordingTo"=>"IUCN Red List (Species Assessed for Global Conservation)", "canonicalForm"=>"Gorilla", "taxonRank"=>"Genus"}, {"identifier"=>39202249, "scientificName"=>"gorilla", "nameAccordingTo"=>"NCBI Taxonomy", "canonicalForm"=>"Gorilla", "sourceIdentfier"=>"9592", "taxonRank"=>"Genus"}, {"identifier"=>46592318, "scientificName"=>"Gorilla I. Geoffroy Saint-Hilaire, 1852", "nameAccordingTo"=>"Integrated Taxonomic Information System (ITIS)", "canonicalForm"=>"Gorilla", "sourceIdentfier"=>"572837", "taxonRank"=>"Genus"}, {"identifier"=>48130282, "scientificName"=>"gorilla", "nameAccordingTo"=>"Species 2000 & ITIS Catalogue of Life: May 2012", "canonicalForm"=>"Gorilla", "sourceIdentfier"=>"11104408", "taxonRank"=>"Genus"}, {"identifier"=>49344957, "scientificName"=>"Gorilla Geoffroy 1852", "nameAccordingTo"=>"Paleobiology Database", "canonicalForm"=>"Gorilla", "sourceIdentfier"=>"urn:paleodb:tn97178", "taxonRank"=>"Genus"}],
        "dataObjects"=>[]
      },
      { "identifier"=>20861821, "scientificName"=>"Gorilla gorilla adenovirus B10", "richness_score"=>1.335, "synonyms"=>[], "vernacularNames"=>[], "references"=>[],
        "taxonConcepts"=>[{"identifier"=>38421984, "scientificName"=>"Gorilla gorilla adenovirus B10", "nameAccordingTo"=>"NCBI Taxonomy", "canonicalForm"=>"Gorilla gorilla adenovirus", "sourceIdentfier"=>"927251"}],
        "dataObjects"=>[]
      }
    ]
  end
